...
def verificarH2H(t1, t2, df_prev_posicoes):
    sum_pct_t1 = 0.00
    sum_pct_t2 = 0.00 
    for i in range(20):
...
team1 = col1.selectbox('Selecione a Equipe 1:', equipes)
team2 = col2.selectbox('Selecione a Equipe 2:', equipes)
p1, p2 = verificarH2H(team1, team2, df_prev_posicoes)

st.markdown(f"<p style='text-align: center;'>A probabilidade do <b>{team1}</b> terminar acima do <b>{team2}</b> é de {p1*100:.2f}%</p>", unsafe_allow_html=True)
st.markdown(f"<p style='text-align: center;'>As odds para <b>{team1}</b> terminar acima do <b>{team2}</b> é de {1/p1:.2f}</p>", unsafe_allow_html=True)
st.write('')
st.markdown(f"<p style='text-align: center;'>A probabilidade do <b>{team2}</b> terminar acima do <b>{team1}</b> é de {p2*100:.2f}%</p>", unsafe_allow_html=True)
st.markdown(f"<p style='text-align: center;'>As odds para <b>{team2}</b> terminar acima do <b>{team1}</b> é de {1/p2:.2f}</p>", unsafe_allow_html=True)
